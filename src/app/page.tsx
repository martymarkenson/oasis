...
import { Check, Mail, CheckCircle2, X, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <div className="bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <br></br>Smart travelers save big while supporting local causes.
            </p>
      ...
      <footer className="bg-blue-600">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              <div className="font-semibold text-white mb-4">Never Miss a Deal</div>
              <p className="text-sm text-blue-100 mb-4">
                Get weekly alerts for the best luxury travel auctions.
              </p>
              <div className="max-w-sm flex gap-2">
                <input 
                  type="email" 
                  placeholder="Enter your email"
                  className="w-[240px] px-4 py-2 rounded-lg bg-white border-0 text-black placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/20"
                />
                <button className="px-4 py-2 rounded-lg font-medium whitespace-nowrap
